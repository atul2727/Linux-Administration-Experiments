...
#### Screenshot:
![Creating the consultants directory](Screenshots/13.png)
...
#### Screenshot:
![Adding write permission to the group](Screenshots/14.png)
...
#### Screenshot:
![Setting permissions using the octal method](Screenshots/15.png)
...
#### Expected Output:
```
drwxrwx--- 2 root consultants 4096 Feb 4 12:34 /home/consultants
```

#### Screenshot:
![Verifying directory permissions](Screenshots/16.png)
...
#### Screenshot:
![Changing and verifying umask](Screenshots/17.png)
...
#### Screenshot:
![Confirming umask with new file and directory](Screenshots/18.png)
